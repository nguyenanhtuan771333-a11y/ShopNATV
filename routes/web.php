...
Route::middleware(['auth', 'check.last.login'])->prefix('/account')->group(function () {
  ...
  Route::prefix('/deposits')->group(function () {
    ...
    Route::get('/raksmeypay', [App\Http\Controllers\Account\DepositController::class, 'raksmeypay'])->name('account.deposits.raksmeypay');
    Route::get('/raksmeypay-success', [App\Http\Controllers\Account\DepositController::class, 'raksmeypaySuccess'])->name('account.deposits.raksmeypay-success');
...
Route::prefix('/cron')->group(function () {
  ...
  // webhook web2m api
  // Route::post('/webhook/deposit/{uuid}', [App\Http\Controllers\Cron\WebhookController::class, 'deposit'])->name('cron.webhook.deposit');
