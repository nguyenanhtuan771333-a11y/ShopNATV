      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('admin.boosting.categories.update', ['id' => $item->id]) }}" method="POST" class="default-form">
              @csrf
              <div class="mb-3">
  ...
  <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.boosting.categories.store') }}" method="POST" class="default-form">
            @csrf
            <div class="mb-3">
              <label for="priority" class="form-label">Ưu tiên</label>
