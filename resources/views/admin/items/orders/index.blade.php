  ...
  <div class="card custom-card">
    ...
    <div class="card-body">
      <div class="table-responsive theme-scrollbar">
        <table class="display table table-bordered table-stripped text-center text-nowrap datatable">
          <thead>
            <tr>
              <th>#</th>
              <th>Thao tác</th>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('admin.items.orders.update', ['id' => $item->id]) }}" method="POST" enctype="multipart/form-data" class="default-form">
              @csrf
              <div class="mb-3">
              ...
              @else
                ...
                <div class="mb-3">
                  <label for="input_ingame_n" class="form-label">Tên trong Game</label>
                  <input type="text" id="input_ingame_n" name="input_ingame_n" class="form-control" value="{{ $item->input_ingame_n ?? '-KHÔNG CÓ-' }}" disabled>
                </div>
              @endif
              <div class="mb-3">
                <label for="input_contact" class="form-label">Liên hệ</label>
                <input type="text" id="input_contact" name="input_contact" class="form-control" value="{{ $item->input_contact ?? '-KHÔNG CÓ-' }}" disabled>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <button class="btn btn-primary-gradient w-100">Cập nhật</button>
              </div>
            </form>
          </div>
        </div>
