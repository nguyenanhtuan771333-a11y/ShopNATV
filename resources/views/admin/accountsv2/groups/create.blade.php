...
@section('content')
  <div class="card custom-card">
    <div class="card-header justify-content-between">
      <div class="card-title">Tạo nhóm mới cho chuyên mục "{{ $category->name }}"</div>
    </div>
    <div class="card-body">
      <form action="{{ route('admin.accountsv2.groups.store', ['id' => $category->id]) }}" method="POST" enctype="multipart/form-data" class="default-form">
        @csrf
        <div class="mb-3">
