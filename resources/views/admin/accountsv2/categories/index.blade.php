              ...
              <tr>
                ...
                <td>
                  <div class="d-flex">
                    ...
                    <a href="{{ route('admin.accountsv2.groups', ['id' => $item->id]) }}" class="badge bg-info-gradient text-white me-1"><i class="fa fa-eye"></i> xem</a>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="{{ route('admin.accountsv2.categories.update', ['id' => $item->id]) }}" method="POST" class="default-form">
              @csrf
              <div class="mb-3">
  ...
  <div class="modal fade" id="modal-create" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ route('admin.accountsv2.categories.store') }}" method="POST" class="default-form">
            @csrf
            <div class="mb-3">
              <label for="priority" class="form-label">Ưu tiên</label>
  ...
  <script>
    const deleteRow = async (id) => {
      ...
      try {
        const {
          data: result
        } = await axios.post('{{ route('admin.accountsv2.categories.delete') }}', {
          id
        })
