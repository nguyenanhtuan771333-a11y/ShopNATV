...
@section('content')
  <div class="card custom-card">
    ...
    <div class="card-body">
      <form action="{{ route('admin.accounts.groups.update', ['id' => $group->id]) }}" method="POST" enctype="multipart/form-data" class="default-form">
        @csrf
        <div class="mb-3">
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="slug" name="slug" placeholder="Nhập slug (tùy chọn)" value="{{ $group->slug }}">
          </div>
        </div>
        <div class="mb-3">
